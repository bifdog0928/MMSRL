...
if __name__ == "__main__":
    ...
    parser.add_argument('--GT_path', default='./DLPFC/GT_labels.txt', type=str, help='GT_path')
    parser.add_argument('--our_path', default='./results/DLPFC.txt', type=str, help='our_path')
    parser.add_argument('--save_path', default='./results/DLPFC_metrics.txt', type=str, help='our_path')
